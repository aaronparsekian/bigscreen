...
//      Serial.print("\t");
//      Serial.print(newPacket.sensor3);
//      Serial.print("\t");
//      Serial.print(newPacket.sensor4);
//      Serial.print("\t");
//      Serial.println(newPacket.sensor5);


    Serial.write(newPacket.sensor0);
    Serial.write(newPacket.sensor1);
    Serial.write(newPacket.sensor2);
    Serial.write(newPacket.sensor3);
    Serial.write(newPacket.sensor4);
    Serial.write(newPacket.sensor5);
